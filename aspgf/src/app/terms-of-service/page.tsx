        ...
        <main className="font-cabin min-h-screen bg-gray-50 pt-32 pb-20 px-6">
            <div className="max-w-4xl mx-auto bg-white rounded-[32px] p-8 md:p-12 shadow-sm border border-gray-100">
                ...
                <section className="space-y-6 text-gray-700 leading-relaxed text-[15px]">
                    ...
                    <h2 className="font-nunito text-xl font-bold text-[#1A2E35] mt-8">1. Agreement to Terms</h2>
                    <p>
                    ...
                    <h2 className="font-nunito text-xl font-bold text-[#1A2E35] mt-8">2. Intellectual Property</h2>
                    <p>
                    ...
                    <h2 className="font-nunito text-xl font-bold text-[#1A2E35] mt-8">3. User Conduct</h2>
                    <p>
                    ...
                    <h2 className="font-nunito text-xl font-bold text-[#1A2E35] mt-8">4. Donation Policy</h2>
                    <p>
