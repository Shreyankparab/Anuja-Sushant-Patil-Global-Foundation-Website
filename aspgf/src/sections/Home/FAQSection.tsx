...
export default function FAQSection() {
  ...
  return (
    <section className="relative w-full py-12 md:py-20 bg-[#f6f1e7] overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 h-[1200px] md:h-[1000px] lg:h-[900px] xl:inset-0 xl:h-full opacity-20 bg-[url('/images/home-page/faqs.webp')] bg-cover bg-top filter blur-sm pointer-events-none"></div>
