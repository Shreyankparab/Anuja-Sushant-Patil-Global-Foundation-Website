...
export default function WhatWeDoSection() {
  ...
  const mainImages = [
    "/images/what-we-do/what-we-do-1.webp",
    "/images/what-we-do/what-we-do-2.webp",
    "/images/what-we-do/what-we-do-3.webp",
    "/images/what-we-do/what-we-do-4.webp",
    "/images/what-we-do/what-we-do-5.webp",
    "/images/what-we-do/what-we-do-6.webp",
  ];

  const secondImages = [
    "/images/what-we-do/what-we-do-7.webp",
    "/images/what-we-do/what-we-do-8.webp",
    "/images/what-we-do/what-we-do-9.webp",
    "/images/what-we-do/what-we-do-10.webp",
    "/images/what-we-do/what-we-do-11.webp",
    "/images/what-we-do/what-we-do-12.webp",
  ];
        ...
        <div className="reveal-left">
          ...
          >
            {tabContent[activeTab].points.map((point, index) => (
              <li
                key={index}
                className={`flex items-start gap-4 transition-all duration-700 transform ${true ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
                  }`}
