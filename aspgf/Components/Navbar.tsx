...
export function Navbar() {
  ...
  return (
    <>
          ...
          <div className="hidden lg:flex items-center gap-6 ml-auto text-[12px]">
            ...
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-[#00715D]/10 flex items-center justify-center">
                <span
                  className={`${nunito.className} text-[#00715D] font-black text-[10px]`}
                >
                  CIN
                </span>
              </div>
              <div>
                <p
                  className={`${nunito.className} text-gray-400 font-bold uppercase tracking-tighter`}
                >
                  Corporate ID
                </p>
                <p
      ...
      {/* MOBILE MENU OVERLAY */}
      <div
        className={`md:hidden fixed inset-0 bg-[#00000080] backdrop-blur-sm transition-all duration-300 z-[10010] ${
          isMenuOpen
      ...
      />{" "}
      <div
        className={`md:hidden fixed top-0 right-0 h-full w-[85%] bg-white shadow-2xl transition-transform duration-500 ease-in-out z-[10015] ${
