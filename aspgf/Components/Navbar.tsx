...
export function Navbar() {
    ...
    return (
        <>
            ...
            {/* MOBILE MENU OVERLAY */}
            <div
                className={`md:hidden fixed inset-0 bg-[#00000080] backdrop-blur-sm transition-all duration-300 z-[10010] ${isMenuOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"
                    }`}
