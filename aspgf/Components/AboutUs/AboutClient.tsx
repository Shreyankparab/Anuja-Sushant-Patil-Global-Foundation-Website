          ...
          {activeTab === "mission" && (
            <div>
              ...
              >
                ...
                opportunities. Our mission is to build inclusive platforms that
                empower communities through education, healthcare, and
              ...
              <ul className="space-y-3">
                ...
                >
                  ...
                  To support students from financially challenged backgrounds by
          ...
          {activeTab === "vision" && (
            <div className="fade-up">
              <p
                className={`${cabin.className} text-gray-600 mb-6 font-normal`}
              >
                To build a society where education empowers, compassion uplifts,
                and equal opportunities enable every individual to lead a life
                of dignity, confidence, and self-reliance creating a future
                where knowledge, innovation, and humanity work together for the
                progress of all.
              </p>
              ...
              <ul className="space-y-3">
                ...
                >
                  ...
                  and scholarships, regardless of financial background.
                </li>
                ...
                >
                  ...
                  children and destitute women to help them rebuild their lives.
                </li>
          ...
          {activeTab === "value" && (
            <div className="fade-up">
              <p
                className={`${cabin.className} text-gray-600 mb-6 font-normal`}
              >
                At Anuja Sushant Patil Global Foundation, our work is guided by
                a strong commitment to integrity, compassion, and sustainable
                social impact. We believe that meaningful change begins with
                responsible action, inclusive opportunities, and a deep respect
                for human dignity. Through our programs in education, community
                welfare, and social development, we strive to empower
                individuals and strengthen communities for a better future.
              </p>
              ...
              <ul className="space-y-3">
                ...
                >
                  <ArrowRight className="text-[#00735C] w-5 h-5 min-w-[20px] mt-1 flex-shrink-0" />
                  Encouraging sustainable development and responsible community
                  engagement.
                </li>
